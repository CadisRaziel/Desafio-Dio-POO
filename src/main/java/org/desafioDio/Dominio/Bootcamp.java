...
public class Bootcamp {
    ...
    private final LocalDate dataFinal = dataInicial.plusDays(45); //-> setando uma data final, daqui 45 dias a partir da data inicial
    private Set<Dev> devsIncritos = new HashSet<>(); // HashSet -> pois a ordem pode se aleatoria
